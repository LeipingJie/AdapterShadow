...
if args.dataset_name in ['sbu', 'sbu_new', 'ucf']:
    args.weights = os.path.join('./checkpoint', 'sbu.ckpt')
    args.root_sbu = '/home/mail/2022s2/s230201709/leiping/dataset/shadow/SBU-shadow'
elif args.dataset_name == 'istd':
    args.weights = os.path.join('./checkpoint', 'istd.ckpt')
elif args.dataset_name == 'cuhk':
    args.weights = os.path.join('./checkpoint', 'cuhk.ckpt')

print('weights: ', args.weights)

# whether save predicted images 
args.save = False
